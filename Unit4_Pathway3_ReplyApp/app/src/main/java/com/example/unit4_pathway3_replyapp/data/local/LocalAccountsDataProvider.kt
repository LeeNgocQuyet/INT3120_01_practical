...
/**
 * An static data store of [com.example.unit4_pathway3_replyapp.data.Account]s. This includes both [com.example.unit4_pathway3_replyapp.data.Account]s owned by the current user and
 * all [com.example.unit4_pathway3_replyapp.data.Account]s of the current user's contacts.
 */
